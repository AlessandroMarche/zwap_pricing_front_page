...
class ZwapStatusTagProviderState extends ChangeNotifier {
  ...
  void onHover(bool isHover) {
    ...
    } else if (!isHover && this.zwapStatusTagType == ZwapStatusTagType.hoverStatus) {
...
class ZwapStatusTagContainer extends StatelessWidget {
  ...
  ZwapStatusTagContainer({Key? key, required this.iconStatus, required this.statusText, required this.callBackClick}) : super(key: key);
      ...
      return InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(
              color: this._getBackGroundColor(provider), borderRadius: BorderRadius.all(Radius.circular(ZwapRadius.defaultRadius)), border: Border.all(color: this._getBorderColor(provider))),
          child: Column(
