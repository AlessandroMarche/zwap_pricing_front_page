...
class ZwapStatusBadge extends StatefulWidget implements ResponsiveWidget {
  ...
  ZwapStatusBadge({Key? key, required this.statusText, required this.statusIcon, required this.statusIconColor, required this.callBackClick, this.isSelected = false}) : super(key: key);
...
class _ZwapStatusBadgeState extends State<ZwapStatusBadge> {
  ...
  void _onHover(bool isHover) {
    setState(() {
      this._currentState = isHover ? ZwapStatusBadgeState.hoverState : ZwapStatusBadgeState.defaultState;
    });
  }
  ...
  Color _getBackGroundColor() {
    ...
    switch (this._currentState) {
      case ZwapStatusBadgeState.defaultState:
        return ZwapColors.shades0;
      case ZwapStatusBadgeState.hoverState:
        return ZwapColors.mappingColor[widget.statusIconColor]!;
    }
  }
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(color: this._getBorderColor(), width: 1, style: BorderStyle.solid),
