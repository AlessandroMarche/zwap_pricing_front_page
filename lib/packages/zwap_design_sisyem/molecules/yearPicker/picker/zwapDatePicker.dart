...
class _ZwapDatePickerState extends State<ZwapDatePicker> {
  ...
  Widget _getCalendarTitle() {
    return Row(
      children: [
        Flexible(
          child: this._currentYear - 10 >= widget.minYear
              ? InkWell(
        ...
        Flexible(
          child: this._currentYear + 10 < widget.maxYear
              ? InkWell(
    ...
    return Center(
      child: ZwapGridView<int>(
          ...
          getChildWidget: (int element) => Container(
                decoration: BoxDecoration(color: this._selectedYear == element ? ZwapColors.neutral400 : ZwapColors.shades0, borderRadius: BorderRadius.all(Radius.circular(10))),
                child: InkWell(
