...
class ZwapTextSection extends StatelessWidget {
  ...
  ZwapTextSection({Key? key, required this.title, required this.corpusText, this.maxChars = 50, this.readMoreText = "Read more", this.readLessText = "Read less"}) : super(key: key);
