...
import 'package:pricing_front_page/packages/zwap_design_sisyem/atoms/constants/zwapConstants.dart';
...
class ZwapBlurComponent extends StatelessWidget {
  ...
  ZwapBlurComponent({Key? key, required this.blurBody, required this.bodyChild}) : super(key: key);
