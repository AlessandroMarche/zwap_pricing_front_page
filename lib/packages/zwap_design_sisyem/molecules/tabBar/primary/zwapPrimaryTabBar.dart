...
class ZwapPrimaryTabBarState extends ChangeNotifier {
  ...
  ZwapPrimaryTabBarState({required this.items}) {
    this.currentSelected = items.first;
  }
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: ZwapText(
                  textColor: provider.currentSelected == key ? ZwapColors.primary800 : ZwapColors.neutral500,
                  text: key,
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: Divider(
                    height: 20,
                    thickness: 2,
                    color: provider.currentSelected == key ? ZwapColors.primary800 : ZwapColors.neutral300,
                  ),
                ),
              )
            ],
