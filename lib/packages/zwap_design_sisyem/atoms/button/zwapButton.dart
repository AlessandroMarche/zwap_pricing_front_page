    ...
    switch (widget.zwapButtonContentType) {
      ...
      case ZwapButtonContentType.withIcon:
        return Row(
          ...
          children: [
            Flexible(
              child: Padding(padding: EdgeInsets.only(right: 3), child: Container() // ZwapIcons.icons(widget.icon!, iconSize: widget._plotIconSize(), iconColor: this._getChildrenColor()),
                  ),
              flex: 0,
              fit: FlexFit.tight,
            ),
      ...
      case ZwapButtonContentType.noLabel:
        return Container(); // ZwapIcons.icons(widget.icon!, iconColor: this._getChildrenColor(), iconSize: widget._plotIconSize());
    }
  }
