...
class ZwapCheckBox extends StatefulWidget {
  ...
  ZwapCheckBox({Key? key, required this.text, required this.onCheckBoxClick, this.initialValue = false, this.onTextClick}) : super(key: key);
