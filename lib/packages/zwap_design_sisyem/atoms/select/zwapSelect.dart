...
class _ZwapSelectState extends State<ZwapSelect> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
          decoration: BoxDecoration(color: ZwapColors.shades0, border: Border.all(color: this._isHover ? ZwapColors.primary300 : ZwapColors.neutral300), borderRadius: BorderRadius.circular(4)),
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: DropdownButton<String>(
                ...
                icon: Icon(
                  !this._isOpen ? Icons.keyboard_arrow_down_rounded : Icons.keyboard_arrow_up_rounded,
